...
with open('/home/dell/one_tcp_flow fqcodel fqpie ecn on-off/FQ-CoDel-ECN-on-off-comparison/netperf-fqcodel-ecn-off.json') as json_file:
    jsondata = json.load(json_file)
 

node_data = jsondata["left-node-0"][0]["10.0.1.1:40533"]
...
data_file = open('netperf_FQ-CoDel_ECN_disabled.csv', 'w', newline='')
