...
rates = [("800Mbps","80Mbps"),("1600Mbps","160Mbps"),("10000Mbps","1000Mbps")] # (Edge bandwidth, bottleneck bandwidth)
ecn_values = [True, False]
delays = [("0.5ms","1ms"),("5ms","10ms"),("10ms","20ms"),("100ms","200ms")] # (Edge delay, bottleneck delay)
flows = [1, 3, 16]
stop_times = [200]
                ...
                for number_of_flow in flows:
                    for duration in stop_times:
                        ...
                        if ecn == True and qdisc == "fqPie":
                            ...
                            left_router_connection.set_attributes(bbw, bd, qdisc, **qdisc_parameters)
                            right_router_connection.set_attributes(bbw, bd, qdisc, **qdisc_parameters)

                        elif ecn == False and qdisc == "fqPie":  
                            qdisc_parameters = {'ecn': ''}   
                            left_router_connection.set_attributes(bbw, bd, qdisc, **qdisc_parameters)
                            right_router_connection.set_attributes(bbw, bd, qdisc, **qdisc_parameters)

                        elif ecn == True and qdisc != "fqPie":
                            # enable ECN in a qdisc in an interface
                            qdisc_parameters = {'ecn': ''}
                            ...
                            left_router_connection.set_attributes(bbw, bd, qdisc)
                            right_router_connection.set_attributes(bbw, bd, qdisc)
